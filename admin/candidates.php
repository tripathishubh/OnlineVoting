  ...
  <footer id="footer" class="hoc clear"> 
    ...
    <div class="one_third">
      ...
      <ul class="nospace linklist contact">
        ...
        <li><i class="fa fa-phone"></i> +91 9643427594<br>
          +91 7065448544</li>
    ...
    <div class="one_third">
      ...
      <ul class="nospace linklist contact">
        ...
        <li><i class="fa fa-envelope-o"></i> almas.kakul19@gmail.com </li>
...
<div class="wrapper row5">
  <div id="copyright" class="hoc clear"> 
    ...
    <p class="fl_left">Copyright &copy; 2019 - All Rights Reserved - <a href="#">Mr. Almas</a></p>
