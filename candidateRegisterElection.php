<?php
 ...
 $mysqli = new mysqli("localhost", "root", "", "poll");
    if(empty($_SESSION['id']) || empty($_SESSION['member_id'])){
...
<?php
     ...
     else if (isset($_GET['election_id']))
     {
       ...
       $election_id = $_GET['election_id'];
         ...
         $result =   $mysqli->query( "INSERT INTO tbcandidates(candidate_id,member_id, election_id) VALUES ('$_SESSION[member_id]','$_SESSION[member_id]','$election_id')" )
         or die("The candidate does not exist ... \n"); 
